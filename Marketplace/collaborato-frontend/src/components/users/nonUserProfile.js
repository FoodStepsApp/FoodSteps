...
/*   */
  ...
  SubmitChanges = (event) => {
    ...
    var requestOptions = {
      ...
      fetch("http://54.215.59.219:8102/api/editProfile", requestOptions)
...
//console.log("VLAUES",this.state.FirstName,this.state.LastName, this.state.emailId,this.state.AboutMe,this.state.City,this.state.Languages,this.state.Gender, this.state.State, this.state.Country,this.state.Contact, this.state.selectValue)
    ...
    componentDidMount() {
        var url = 'http://54.215.59.219:8102/api/get/'+localStorage.getItem("nonusername")
      ...
      var url = 'http://54.215.59.219:8102/api/getFriends?user='+localStorage.getItem("emailId");
      fetch(url, {
        method: 'get'
      })
      .then((response)=> {
    ...
    var url = 'http://54.215.59.219:8102/api/getusers'
    fetch(url, {
      method: 'get'
    })
    .then((response)=> {
...
var url = 'http://54.215.59.219:8102/api/getRequests?user='+this.state.PrimaryEmail;
...
//   .catch(error => console.log('error', error));
    ...
    var url = 'http://54.215.59.219:8102/api/image-upload?title='+localStorage.getItem("nonusername")+'&username='+localStorage.getItem("nonusername")
...
sendFriendRequest = () => {
    ...
    this.setState({pendingFriend:true})
    fetch('http://54.215.59.219:8102/api/sendRequest', {
      method: 'post',
