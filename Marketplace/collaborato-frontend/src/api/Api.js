import {BASE_URL_FEED,BASE_URL_PYTHON,BASE_URL_CART,BASE_URL_FAV,ID_USER,BASE_URL_PAY} from './../components/constants/constants.js';
...
export function pay(data) {
  return fetch(`${BASE_URL_PAY}/api/payment`, {
    method: "POST",
    headers: {
      "Content-Type": "application/json",
    },
